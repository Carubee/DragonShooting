...
public static class uDialog_Fluent
{
    ...
    /// <param name="showButtons"></param>
    /// <returns></returns>
    public static uDialog AddButton(this uDialog uDialog, uDialog_Button_Data button, bool showButtons = true)
    {
    ...
    /// <param name="showButtons"></param>
    /// <returns></returns>
    public static uDialog AddButton(this uDialog uDialog, string buttonText, UnityAction buttonAction, bool showButtons = true)
    {
        return uDialog.AddButton(new uDialog_Button_Data { ButtonText = buttonText, OnClick = buttonAction }, showButtons);
    }
    ...
    /// <param name="showButtons"></param>
    /// <returns></returns>
    public static uDialog AddButton(this uDialog uDialog, string buttonText, UnityAction<uDialog> buttonAction, bool showButtons = true)
    {
    ...
    /// <param name="showButtons"></param>
    /// <returns></returns>
    public static uDialog AddButton(this uDialog uDialog, string buttonText, UnityAction<uDialog, uDialog_Button_Data> buttonAction, bool showButtons = true)
    {
        ...
        return uDialog.AddButton(button, showButtons);
    }    
    ...
    /// <returns></returns>
    public static uDialog SetContent(this uDialog uDialog, RectTransform contentTransform, float? preferredHeight = null)
    {
